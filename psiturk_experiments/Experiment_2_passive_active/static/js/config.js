...
var Config = function(condition, counterbalance) {
    ...
    this.parse_config = function(data) {
        ...
        this.trials = JSON.parse(JSON.stringify(data["stim"])); //Clones the array rather than shallow copying it;
        ...
        this.trials.unshift(data["stim"][4]);
        this.trials.unshift(data["stim"][0]);
